...
MockClient createHealOnMockClient({
  ...
  return MockClient((request) async {
    ...
    switch (key) {
      ...
      case 'GET /api/employee/leave-types/':
        return http.Response(leaveTypesResponse, 200);
      case 'GET /api/employee/documents/':
        return http.Response(employeeDocumentsResponse, 200);
